...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('posts', function (Blueprint $table) {
            ...
            // Open Graph (Facebook/LinkedIn) Alanları
            $table->json('og_title')->nullable()->after('focus_keyword');
            ...
            $table->enum('schema_article_type', ['Article', 'BlogPosting', 'NewsArticle', 'Product', 'Service', 'FAQPage', 'HowTo', 'LocalBusiness', 'Person'])->default('BlogPosting')->after('schema_type');
