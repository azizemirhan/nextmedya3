...
<div class="row layout-spacing mt-4">
    ...
    <div class="col-12 col-lg-8">
        <div class="card mb-3">
            <div class="card-header">
                <h5 class="mb-0">Özellik Bilgileri</h5>
            </div>
            <div class="card-body">
                {{-- Dil sekmeleri --}}
                    ...
                    <div class="tab-pane fade show active" id="tr-content" role="tabpanel">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title[tr]" class="form-control"
                                   value="{{ old('title.tr', $feature->title['tr'] ?? '') }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Açıklama (TR)</label>
                            <textarea name="description[tr]" class="form-control"
                                      rows="4">{{ old('description.tr', $feature->description['tr'] ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="en-content" role="tabpanel">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title[en]" class="form-control"
                                   value="{{ old('title.en', $feature->title['en'] ?? '') }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Description (EN)</label>
                            <textarea name="description[en]" class="form-control"
                                      rows="4">{{ old('description.en', $feature->description['en'] ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-4">
        ...
        <div class="d-grid gap-2">
            ...
            <a href="{{ route('admin.features.index') }}" class="btn btn-light">Listeye Dön</a>
        </div>
    </div>
</div>
